...
import ejercicioshbm.ej4_1.Seguro.Sexo;
import ejercicioshbm.ej4_1.Seguro.TipoSeguro;

public class Lanzador {
	public static void main(String[] args) throws ParseException {
		System.out.println("Ejercicio 4.1");
		File cfgPath = new File("resources/ej4_1/hibernate.cfg.xml");
		...
		seguro1.setCasado(true);
		seguro1.setEdad(20);
		seguro1.setFechaCreacion(Date.from(Instant.now()));
		seguro1.setNumHijos(0);
		seguro1.setSexo(Sexo.HOMBRE);
		seguro1.setTipoSeguro(TipoSeguro.HOGAR);
		seguro1.setFechaNacimiento(new SimpleDateFormat("dd-MM-yyyy").parse("29-10-1999"));
		seguro1.setHoraContacto(new SimpleDateFormat("hh:mm:ss").parse("15:05:25"));
		seguro1.setComentarios("Hola mundo");
		seguro1.setClaves(new char[] {'H', 'I'});
